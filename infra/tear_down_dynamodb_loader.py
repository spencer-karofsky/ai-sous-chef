"""
infra/tear_down_dynamodb_loader.py

Description:
    * Tears down AWS Infrastructure for the DynamoDB loader

Instructions:
    * Run via CLI:
        cd ./ai-sous-chef/
        python -m infra.tear_down_dynamodb_loader
...
def tear_down_dynamodb_loader():
    ec2_client = boto3.client('ec2', region_name='us-east-1')

    # Terminate EC2 instance
    instance_id = find_instance_by_name(ec2_client, 'dynamodb-loader')
    if instance_id:
