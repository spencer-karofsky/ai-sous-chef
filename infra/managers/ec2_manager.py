...
from infra.interfaces.ec2_interface import EC2InstancesInterface, EC2KeyPairInterface, EC2VolumeInterface
...
class EC2InstancesManager(EC2InstancesInterface):
    ...
    def launch_instance(self,
        ...
        Args:
            ...
            key_name: the key name of the already created key pair
            security_group_ids: list of security group policies to apply
            iam_instance_profile: IAM instance profile name for S3/SSM permissions
            user_data: bash script to run on first boot
        Return:
